...
@Composable
fun jugar(navController:NavHostController){
    Column(verticalArrangement = Arrangement.Center) {
        ...
        Button(onClick = {
            navController.navigate("GananBlancas")
        },
        modifier = Modifier
        ...
        Button(onClick = {
            navController.navigate("GananNegras")
        },
            modifier = Modifier
                .padding(horizontal = 30.dp)
        ) {
...
@Composable
fun inicio_juego(){
    jugar(navController = rememberNavController())
}